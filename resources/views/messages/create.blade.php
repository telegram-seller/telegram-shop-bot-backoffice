    ...
    <form action="{{ route("messages.store") }}" method="post">
        ...
        <div class="flex flex-wrap mx-5 gap-y-4 gap-x-5">
            ...
            <div class="flex flex-col w-full">
                ...
                <textarea placeholder="Conteúdo da mensagem" name="content" id="content" cols="30" rows="10" class="border rounded-lg border-black px-2 py-1 hover:drop-shadow-md focus:drop-shadow-lg"></textarea>
            </div>
