...
@section('content')
    <div class="m-10">
        <div class="">
            <h1 class="text-2xl font-medium ">Criar nova mensagem</h1>
        </div>
        <br>
            ...
            <form action="{{ route("messages.store") }}" method="post">
                ...
                <div class="flex flex-wrap  gap-y-4 gap-x-5">
                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <textarea placeholder="Conteúdo da mensagem" name="content" id="content" cols="30" rows="10" class="border rounded-lg border-black mt-2 px-2 py-1 duration-150 hover:drop-shadow-md focus:drop-shadow-lg"></textarea>
                    </div>
